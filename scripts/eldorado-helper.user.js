...
// @connect      localhost
// @connect      *
// @updateURL    https://ody.farm/userscripts/eldorado-helper.user.js
// @downloadURL  https://ody.farm/userscripts/eldorado-helper.user.js
...
(function() {
    ...
    // v9.9.3: Get shop name - uses local cache first (instant)
    function getShopName() {
        // If cache belongs to current farmKey, use it
...
${searchVariations}`;
    ...
    async function fillOfferForm() {
        ...
        // v10.0.10: Debug income value
        console.log('[Glitched] Income from offerData:', income, 'type:', typeof income);
        console.log('[Glitched] incomeText from offerData:', offerData.incomeText);
        ...
        try {
            ...
            console.log('[Glitched] Expected income range:', expectedIncomeRange, 'from income:', income);
