...
const MAX_RECORDS = {
    realtime: 150,  // Показываем все точки (было 100)
    hour: 120,      // 1 точка в 30 сек (было 60)
    day: 576,       // 1 точка в 2.5 мин (было 288)
    week: 672,      // 1 точка в 15 минут (было 336)
    month: 1440     // 1 точка в 30 минут (было 720)
};
